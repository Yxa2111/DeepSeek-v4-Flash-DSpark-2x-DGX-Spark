...
awk '
  BEGIN {
    split("DSPARK_VLLM_IMAGE WORKER_DIR WORKER_SCRIPT_DIR KV_OFFLOAD_ROOT WORKER_KV_OFFLOAD_ROOT KV_OFFLOAD_MODE KV_OFFLOAD_CPU_BYTES KV_OFFLOAD_READ_THREADS KV_OFFLOAD_WRITE_THREADS KV_OFFLOAD_PYTHONHASHSEED KV_OFFLOAD_MAX_TRANSFER_CHUNK_BYTES DSPARK_KV_OFFLOAD_DIAG DSPARK_SPECULATION DSPARK_RESTART_POLICY MAX_MODEL_LEN MAX_NUM_SEQS MAX_NUM_BATCHED_TOKENS DSPARK_BOOT_SHAPE_WARMUP ENABLE_VL_SIDECAR", keys, " ")
